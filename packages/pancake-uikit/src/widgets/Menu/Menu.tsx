    ...
    <Wrapper>
      <StyledNav showMenu={showMenu}>
        <Flex>
          ...
          {/* <Text fontWeight="bold">SQUID NFT GAME</Text> */}
          {!isMobile && <MenuItems items={links} activeItem={activeItem} activeSubItem={activeSubItem} ml="12px" />}
        </Flex>
        <Flex alignItems="center">
          ...
          {/* {!isMobile && (
            <Box mr="24px">
              <StyledSocialLinks pb={["42px", null, "0px"]} mb={["0", null, "0px"]} />
            </Box>
          )} */}
          {userMenu}
        </Flex>
